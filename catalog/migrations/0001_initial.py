    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('white', 'White'), ('black', 'Black'), ('brown', 'Brown'), ('gray', 'Gray'), ('beige', 'Beige')], max_length=20)),
                ('material', models.CharField(choices=[('wood', 'Wood'), ('metal', 'Metal'), ('glass', 'Glass'), ('leather', 'Leather'), ('textile', 'Textile'), ('plastic', 'Plastic')], max_length=20)),
